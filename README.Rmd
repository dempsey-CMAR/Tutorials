...
To do the tutorials, clone this repository to your own computer. Each tutorial folder contains all the code files and data needed to do that tutorial. Do not remove the tutorial folders from your local repository as this will cause file paths to become incorrect. 
