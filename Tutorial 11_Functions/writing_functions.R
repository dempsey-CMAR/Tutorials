...
source(here("functions/give_praise.R"))
...
# source function
source(here("functions/plot_strings_data.R"))

# plot using the new function
plot_strings_data(dat, plot_title = "Example Data")

# try on different areas
birchy_head <- fread(here("data/Birchy Head_2019-05-02_TEMP_DO_SAL_trimmed.csv")) 

old_point <- fread(here("data/Old Point Channel_2016-11-26_TEMP_trimmed.csv")) 


plot_strings_data(birchy_head)

plot_strings_data(old_point)
